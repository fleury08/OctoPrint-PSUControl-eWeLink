...
│   ├── docs/                          # Documentation
│   └── pyproject.toml                # Version (line 16), dependencies, metadata
│
...
| **Plugin version** | `pyproject.toml` (line 16), `docs/CHANGELOG.md` |
...
| [`pyproject.toml`](pyproject.toml) | Version (line 16), dependencies, metadata |
...
1. Bump version in `pyproject.toml` (line 16)
